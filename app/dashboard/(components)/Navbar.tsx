...
const Navbar = () => {
    ...
    return (
        <div className="flex items-center justify-between p-4  ">
            ...
            {/*icon and user*/}
            <div className="flex items-center gap-4 text-info-dart">
                ...
                <div className="flex items-center justify-center text-xl rounded-full cursor-pointer relative">
                    <MdNotifications/>
                    <div className="absolute -top-2 -right-2 w-4 h-4 flex items-center justify-center rounded-full bg-success text-[10px] text-info-dart">1</div>
                </div>
