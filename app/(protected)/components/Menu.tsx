            ...
            if (it.visible.includes(role)) {
              return (
                <Link
                  key={index}
                  href={it.href}
                  className="flex items-center justify-center lg:pl-4 lg:justify-start gap-4 hover:text-accent-dark rounded-md hover:bg-primary/70 hover:text-white py-2 transition-all duration-300"
                >
